...
# Generate baseline for CINIC-10 using Resnet18
...
def main(data_path, output_file, train_percent=0.1, batch_size=320, epochs=150, gpu=0, seeds=[42]):
    ...
    for idx, seed in enumerate(seeds):
        ...
        train_loader, val_loader, test_loader = datasets.get_CINIC10(data_path, batch_size)
        ...
        filename = f"baseline_CINIC10_Resnet18_{seed}.pt"
        torch.save(trainer.model.state_dict(), os.path.join('/home/alsch/PycharmProjects/RHO-Loss-Reproduction/src'
                                                            '/scripts/figure_2/0_baseline', filename))
